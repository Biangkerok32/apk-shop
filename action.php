				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product/$pro_image' style='width:160px;height:250px;'/>
								</div>
...
if(isset($_POST["get_cart_product"]) || isset($_POST["cart_checkout"])){
		...
		if($count > 0){
			...
			while($row=mysqli_fetch_array($run_query)){
				...
				<div class='row'>
					...
					<div class='col-md-3'><img src = 'product/$pro_image' width='60px' height='50px'></div>
				...
				$no = $no + 1;
					...
					echo "
						...
						<div class='row'>
							...
							<div class='col-md-2'><img src='product/$pro_image' width='50px' height='60px'></div>
		...
		if(isset($_POST["cart_checkout"])){
			...
			<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
				...
				<input style="float:right;margin-right:0%;" type="image" name="submit"
